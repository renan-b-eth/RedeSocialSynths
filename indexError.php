    ...
    <body onload="chargeWallpaper()">
        ...
        <div id="container" style="right: 0;">
            <div id="content" style="display: none;">
                ...
                <div id="inputs">
                    <form id="validateEmail" name="pegarDados" method="post" action="checkEmail.php">
                        <input class="buttonSend" type="submit" value="" title="Verificar Email">
                        <input class="inputEmail" type="email" name="email" placeholder="Digite seu email" required>
                    </form>
                </div>
                <div class="invalidDate">Este e-mail não está associado a uma conta Synth's. <a href="createAccount.php" style="color: #0ACDC2; text-decoration: none;">Crie uma conta agora</a>. Venha participar da nossa comunidade.</div>
            </div>
        </div>
