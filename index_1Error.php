    ...
    <body onload="chargeWallpaper()">
        ...
        <div id="container" style="right: 0;">
            <div id="content" style="display: none;">
                ...
                <div class="invalidDate">Tem mesmo certeza que essa é a sua senha? <a href="redefinePassword.php" style="color: #0ACDC2; text-decoration: none;">Redefine-a clicando aqui </a> ou <a href="createAccount.php" style="color:#0ACDC2; text-decoration: none;">clique aqui</a> para criar uma conta nova.</div>
